...
void Skybox::loadFromFaces(const std::vector<std::string>& faces)
{
...
void elix::Skybox::loadFromHDR(const std::string &path)
{
    ...
    frameBuffer.addAttachment(elix::GLFrameBuffer::Attachment::DEPTH);
    frameBuffer.create(CUBE_MAP_SIZE, CUBE_MAP_SIZE, elix::GLFrameBuffer::InternalFormat::DEPTH24);
