...
namespace components
{
    ...
    void AnimatorComponent::calculateObjectTransform(animation::Animation *animation, float currentTime)
    {
    ...
    void AnimatorComponent::playAnimation(animation::Animation *animation, const bool repeat)
    {
    ...
    void AnimatorComponent::calculateBoneTransform(Skeleton::BoneInfo *boneInfo, const glm::mat4 &parentTransform, animation::Animation *animation, const float currentTime)
    {
